...
var createSlots = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, slot_service_1.SlotServices.createSlotsIntoDB(req.body)];
            case 1:
                result = _a.sent();
                if (!result.length) {
                    throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Slots could not be created");
                }
...
var getAvailableSlots = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var getAllSlots = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
