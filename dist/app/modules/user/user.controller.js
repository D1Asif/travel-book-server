...
var getAllUsers = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_service_1.UserServices.getAllUsersFromDB(req.query)];
            case 1:
                result = _a.sent();
                (0, sendResponse_1.default)(res, {
                    statusCode: http_status_1.default.OK,
...
var getUserById = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_service_1.UserServices.getUserByIdFromDB(req.params.userId)];
            case 1:
                result = _a.sent();
                (0, sendResponse_1.default)(res, {
                    statusCode: http_status_1.default.OK,
...
var updateUser = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_service_1.UserServices.updateUserIntoDB(req.params.userId, req.user.id, req.body)];
            case 1:
                result = _a.sent();
                (0, sendResponse_1.default)(res, {
                    statusCode: http_status_1.default.OK,
...
var unfollowUser = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_service_1.UserServices.unfollowUser(req.params.userId, req.user.id)];
            case 1:
                result = _a.sent();
                (0, sendResponse_1.default)(res, {
                    statusCode: http_status_1.default.OK,
